...
?>
				...
				<TR VALIGN="middle" HEIGHT=90>
					...
					<TD CLASS="data" WIDTH=90><CENTER><A HREF="get_report.php?mode=show_received"><IMG SRC="images/b-export.gif" WIDTH=50 HEIGHT=50 ALT="" BORDER=0><BR><?php echo "Show Received"; ?></A></CENTER></TD>
					<TD CLASS="data" WIDTH=90><CENTER><A HREF="get_report.php?mode=get_report"><IMG SRC="images/b-export.gif" WIDTH=50 HEIGHT=50 ALT="" BORDER=0><BR><?php echo "Get Report"; ?></A></CENTER></TD></TR>
				<TR VALIGN="middle" HEIGHT=90>
					<TD CLASS="data" WIDTH=90><CENTER><form action='sendsms.php' method='post'><input type='hidden' name='schedule' value='schedule'/><input type='image' src='images/b-mail.gif'/><br>Schedule SMS</br></form></CENTER></TD>
